...
class TrafficIngestor(BaseTrafficIngestor):
    ...
    # ============== 配置 ==============
    HOST_CODE_PATH = os.path.join(_project_root, 'traffic_capture_single_csv_threads')
    BASE_DST = f'/netdisk/mlj/urls_tls13_traditional_top100/20260605/'
    RETRY = 5
    ...
    CSV_PATH = os.path.join(_project_root, 'small_tools', 'result', 'urls_tls13_traditional_top100.csv')
