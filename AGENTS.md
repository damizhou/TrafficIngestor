...
FRA 默认使用 Docker 网络 `traffic_ingestor_fixed_ip_europe_net`、子网 `172.18.0.0/22`、网关 `172.18.0.1`、容器 IP 范围 `172.18.0.2` 至 `172.18.3.254`；
SGP 默认使用 Docker 网络 `traffic_ingestor_experiment_e1_sgp_net`、子网 `172.18.4.0/22`、网关 `172.18.4.1`、容器 IP 范围 `172.18.4.2` 至 `172.18.7.254`。
