"""Chrome facade for captures with QUIC disabled."""
...
class NoQuicChromeDriverFactory(BaseChromeDriverFactory):
    """Create Chrome with QUIC disabled."""

    def get_startup_arguments(self, context):
        return ("--disable-quic",)


_FACTORY = NoQuicChromeDriverFactory()
