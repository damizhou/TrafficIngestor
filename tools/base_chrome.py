...
class BaseChromeDriverFactory:
    """Build Chrome drivers while allowing variants to override network settings."""
    ...
    def create_driver(self, task_name=None, formatted_time=None, parsers=None,
                      ...
                      chromedriver_path=None, artifact_label=None, context=None):
...
def _install_chrome_managed_policy(policy, logger=None):
...
def _create_chrome_driver(factory, task_name=None, formatted_time=None, parsers=None,
                          enable_ssl_key_log=True, data_base_dir=None,
                          proxy_server=None, proxy_bypass_list=None, logger=None,
                          blocked_hosts=None, chrome_binary_path=None,
                          chromedriver_path=None, artifact_label=None, context=None):
    ...
    _LANG_PRIMARY = "zh-CN"
    _DISABLED_CHROME_FEATURES = ",".join(factory.get_disabled_features(context))
    ...
    for argument in factory.get_startup_arguments(context):
