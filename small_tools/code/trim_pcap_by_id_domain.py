...
- Preview current Firefox output:
  python small_tools/code/trim_pcap_by_id_domain.py
- Delete extra pcaps:
  python small_tools/code/trim_pcap_by_id_domain.py --apply
- Delete side artifacts left after a previous pcap-only trim:
  python small_tools/code/trim_pcap_by_id_domain.py --clean-orphans --apply
- Use a custom output directory:
  python small_tools/code/trim_pcap_by_id_domain.py --base-dir /netdisk/mlj/20260626/temp --limit 120
"""
