...
# ============== 配置 ==============
_legacy_data_dir = os.path.join(_project_root, 'trafficIngestor')
ALL_CSV_PATH = os.path.join(_legacy_data_dir, 'collected_request_urls_all.csv')
TEMP_CSV_PATH = os.path.join(_legacy_data_dir, 'collected_request_urls_temp.csv')
# =================================
