...
- 输出: scripts/result/ech_top10.csv
- 重复次数: 1
...
DEFAULT_INPUT = SMALL_TOOLS_DIR / "origin" / "cl_url.txt"
DEFAULT_OUTPUT = SMALL_TOOLS_DIR / "result" / f"{DEFAULT_INPUT.stem}_fra_chrome.csv"
