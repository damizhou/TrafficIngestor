...
使用方式:
- 预览删除: python scripts/code/cleanup_single_url_domains.py --dry-run
- 实际删除: python scripts/code/cleanup_single_url_domains.py --base-dir /netdisk/ww/top2000/subpages
"""
